...
plot(1979+aux/12,prec,"line",xlab="Año",ylab="Precipitacion (mm)",main="Estacion Río Maule en Armerillo")
...
plot(1979+aux/12,evap,"line",xlab="Año",ylab="Evapotranspiración (mm)",main="Estación Río Maule en Armerillo")
...
plot(1979+aux/12,caud,"line",xlab="Año",ylab="Caudal (m3/s)",main="Estación Río Maule en Armerillo")
lines(1979+aux/12,recta_es,lwd="3",col="red")
legend("topright",c("Promedio"), col = "red", lwd="5")

#TEMPERATURA

plot(1979+aux/12,tmax,"line",xlab="Año",ylab=" Temperatura (°C)",main="Estación Río Maule en Armerillo",ylim = c(-10,30),lwd="1",col="red")
...
#PRECIPITACION
hist(prec,main="Histograma Estación Río Maule en Armerillo",ylab = "", xlab = "",axes=TRUE, breaks =15)
par(new=TRUE)
plot(density(prec),ylab = "Frecuencia", xlab = "Precipitación (mm)", axes=FALSE,lwd=2.5, main = "Histograma Estación Río Maule en Armerillo")
...
#EVAPOTRANSPIRACION
hist(evap,main="Histograma Estación Río Maule en Armerillo",ylab = "", xlab = "",axes=TRUE, breaks=15,  xlim = c(0,200))
par(new=TRUE)
plot(density(evap),ylab = "Frecuencia", xlab = "Evapotranspiración (mm)", axes=FALSE,lwd=2.5, main = "Histograma Estación Río Maule en Armerillo")
freq = c(0:2)
...
#TEMPERATURA
h=hist(tmax,main="Histograma Estación Río Maule en Armerillo", col=rgb(1, 0, 0), ylab = "Frecuencia", xlab = "Temperatura (°C)",axes=TRUE, xlim=c(-10,30))
hist(tmin,add=TRUE,axes=TRUE,col=rgb(0, 0, 1, alpha = 0.5),main="Histograma Estación Río Maule en Armerillo",ylab = "Frecuencia", xlab = "Temperatura (°C)", breaks = 15)
