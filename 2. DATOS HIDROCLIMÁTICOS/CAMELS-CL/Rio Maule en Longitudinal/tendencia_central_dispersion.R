...
agno=PP_series$year
prec = PP_series$X7322001
evap = PE_series$X7322001
caud = ES_series$X7322001 
tmin = TMin_series$X7322001
tmax = TMax_series$X7322001
aux = c(1:length(agno))
...
plot(1979+aux/12,prec,"line",xlab="Año",ylab="Precipitacion (mm)",main="Estación Río Maule en Longitudinal")
...
plot(1979+aux/12,evap,"line",xlab="Año",ylab="Evapotranspiración (mm)",main="Estación Río Maule en Longitudinal")
...
plot(1979+aux/12,caud,"line",xlab="Año",ylab="Caudal (m3/s)",main="Estación Río Maule en Longitudinal")
lines(1979+aux/12,recta_es,lwd="3",col="red")
legend("topright",c("Promedio"), col = "red", lwd="5")

#TEMPERATURA

plot(1979+aux/12,tmax,"line",xlab="Año",ylab=" Temperatura (°C)",main="Estación Río Maule en Longitudinal",ylim = c(-10,30),lwd="1",col="red")
...
#PRECIPITACION
hist(prec,main="",ylab = "", xlab = "",axes=TRUE, breaks=15)
par(new=TRUE)
plot(density(prec),ylab = "Frecuencia", xlab = "Precipitación (mm)", axes=FALSE,lwd=2.5, main = "Histograma Estación Río Maule en Longitudinal")
...
#EVAPOTRANSPIRACION
hist(evap,main="",ylab = "", xlab = "",axes=TRUE, breaks=15)
par(new=TRUE)
plot(density(evap),ylab = "Frecuencia", xlab = "Evapotranspiración (mm)", axes=FALSE,lwd=2.5, main = "Histograma Estación Río Maule en Longitudinal")
freq = c(0:2)
...
#TEMPERATURA
h=hist(tmax,main="Histograma Estación Río Maule en Longitudinal", col=rgb(1, 0, 0), ylab = "Frecuencia", xlab = "Temperatura (°C)",axes=TRUE, xlim=c(-10,30),breaks=15)
hist(tmin,add=TRUE,axes=TRUE,col=rgb(0, 0, 1, alpha = 0.5),main="Histograma Estación Río Maule en Longitudinal",ylab = "Frecuencia", xlab = "Temperatura (°C)", breaks = 15)
